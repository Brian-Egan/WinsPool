...
class DraftsControllerTest < ActionController::TestCase
  ...
  test "should create draft" do
    assert_difference('Draft.count') do
      post :create, draft: { pick: @draft.pick, round: @draft.round, team_id: @draft.team_id, user_id: @draft.user_id }
    end
  ...
  test "should update draft" do
    patch :update, id: @draft, draft: { pick: @draft.pick, round: @draft.round, team_id: @draft.team_id, user_id: @draft.user_id }
    assert_redirected_to draft_path(assigns(:draft))
  end
