...
(function() {
  $(document).delegate("#draftSubmit", "click", function() {
    var pickNumber, playerName, playerPos, roundNumber, subMit, teamNum;
    ...
    return $.post('/drafts', subMit, null, "script");
  });

  $(document).delegate(".dSumTeam", "click", function() {
    var subMit, teamNum;
    ...
    return $.get('/usermodal', subMit, null, 'script');
  });

  $(document).delegate(".playerRow", "click", function() {
    var pickNumber, roundNumber, subMit, teamName, userNum;
  ...
  $(document).delegate("*[data-spinner]", "click", function() {
    console.log("yo dog, data spinners been clicked!");
    return $("#SpinnerModal").modal('toggle');
  });

  $(document).delegate(".posBtn", "click", function() {
    var playerPos, roundNumber, subMit;
    ...
    return $.get('/sortPOS', subMit, null, 'script');
  });

  $(document).delegate(".ownerName", "click", function() {
    var mBody, subMit, teamNum;
    ...
    return $.get('/team/modal', subMit, null, 'script');
  });

  $(document).ready(function() {
    return $('.wklyPoints').hide();
  });

  $(document).delegate(".pointsBtn", "click", function() {
    var typeShow;
    ...
    return console.log(typeShow);
  });

  $(document).delegate("#sortPoints", "click", function() {
    var subMit;
    ...
    console.log("Points!");
    return $.get('/playerssort', subMit, null, 'script');
  });
...
(function() {
  $(document).delegate(".saveGame", "click", function() {
    var gameNum, hInputID, hScore, hTeam, subMit, vInputID, vScore, vTeam;
    ...
    return $.get('/schedule/updateScore', subMit, null, "script");
  });

  $(document).delegate(".wkBtn", "click", function() {
    var WeekNum, subMit;
    ...
    return $.get('/schedules', subMit, null, 'script');
  });

  $(document).delegate(".NFLTeamSched", "click", function() {
    var subMit, teamNum;
    ...
    return $.get('/NFLTeamSched', subMit, null, 'script');
  });

}).call(this);
(function() {
  $(document).delegate("#SignUpTab", "click", function() {
    console.log("session js file click");
    $(this).addClass("active");
    return $.get('/signup', null, null, "script");
  });

  $(document).delegate("#SignInTab", "click", function() {
    console.log("session js file click");
    $(this).addClass("active");
    return $.get('/login', null, null, "script");
  });
...
// };
(function() {
  $(document).delegate(".testJSBtn", "click", function() {
    return $.get('/testJS', null, null, 'script');
  });

}).call(this);
(function() {
  $(document).delegate(".playerTeam", "click", function() {
    var subMit, teamNum;
    teamNum = $(this).data('userid');
    subMit = {
      utf: "✓",
...
//   $('.draftSummaryTable').each(function() {
//     var $table = $(this);
